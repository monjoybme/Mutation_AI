...
This code is made available under the **GNU General Public License v3.0 (GPLv3)**.

You are free to use, modify, and redistribute this software in accordance with the terms of the GPLv3 license.

This software is provided for **non-commercial academic purposes**. Any commercial use, distribution, sublicensing, or incorporation into proprietary products requires prior written permission from the copyright holder.

See the [LICENSE](LICENSE) file for the full GPLv3 license text.

© Monjoy.AI. All rights reserved.
